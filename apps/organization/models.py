...
class CourseOrg(models.Model):
    city = models.ForeignKey(CityDict, verbose_name="所在城市", on_delete=models.SET_NULL, null=True)
...
class Teacher(models.Model):
    org = models.ForeignKey(CourseOrg, verbose_name="所属机构", on_delete=models.SET_NULL, null=True)
